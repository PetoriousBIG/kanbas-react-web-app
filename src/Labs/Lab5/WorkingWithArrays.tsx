...
export default function WorkingWithArrays() {
  ...
  return (
    <div id="wd-working-with-arrays">
      ...
      <input value={todo.id} className="form-control w-25 float-start me-2"
        onChange={(e) => setTodo({ ...todo, id: e.target.value })}/>
      <label htmlFor="array-update"> Click this CB</label>
      <input id="array-update" type="checkbox" className="form-check-input" checked={todo.completed}
      ...
      <input value={todo.id} className="form-control w-25 float-start me-2"
        onChange={(e) => setTodo({ ...todo, id: e.target.value})}/>
      <input type="text" className="form-control w-50 float-start" value={todo.description}
